...
![](img/img/accueil_eon.png)

![](img/add_host_btn.png)
![](img/add_host.png)
...
![](img/template_btn.png)

![](img/host_template.png)
...
![](img/reload.png) Vous devriez voir apparaître des éléments supplémentaires dans la console des logs afin de voir où l&#39;application de la configuration a échouée.
...
![](img/modify_method_btn.png)

Vous allez donc arriver sur la page ci-dessous.

![](img/modify_method.png)
