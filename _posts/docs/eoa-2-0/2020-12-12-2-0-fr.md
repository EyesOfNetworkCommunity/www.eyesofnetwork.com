...
- [Installation](#Installation)
  ...
  * [Configuration d’Eyes Of Network](#Configuration-d-EyesOfNetwork)
  * [Selenium](#selenium)
...
| `WaitForElement "//li/div/div" $ImgTimeout -ByXPath –IsClickable` | Recherche d’élément de type XPath, et verification qu’il est bien clickable |
